...
DATA_ROOT = Path(__file__).absolute().parent / args.data_path if "args" in locals() else Path(__file__).absolute().parent / 'data'
...
def add_args(parser):
    ...
    arg('--data-path', default='data_full', help='Path to dataset directory')
